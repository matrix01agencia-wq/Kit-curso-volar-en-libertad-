...
En este CTA en blanco quiero poner el enlace de pago con un botón que diga acceder antes 1780 ahora 20 usd .

Ese es el código. Dame otra vez el código editado solo con lo que te estoy pidiendo:
